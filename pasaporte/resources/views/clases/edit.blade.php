...
<div class="card-body">
    <form method="POST" action="{{route('clases.update', $clase)}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="clase_hora_inicio" type="time" class="form-control @error('clase_hora_inicio') is-invalid error-input @enderror" name="clase_hora_inicio" value="{{ \Carbon\Carbon::parse($clase->clase_hora_inicio)->format('G:i') }}" required autocomplete="clase_hora_inicio" autofocus>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="clase_hora_fin" type="time" class="form-control @error('clase_hora_fin') is-invalid error-input @enderror" name="clase_hora_fin" value="{{ \Carbon\Carbon::parse($clase->clase_hora_fin)->format('G:i') }}" required autocomplete="clase_hora_fin" autofocus>
