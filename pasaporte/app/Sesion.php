    ...
    */
    ...
    static public function getSesions(User $user)
    {
        return Sesion::where('user_id', $user->id)
            ...
            ->select('clase_user.id', 'clase_user.created_at', 'users.name', 'users.email', 'clases.clase_nombre', 'clases.clase_hora_inicio', 'clases.clase_hora_fin', 'coaches.coach_nombre', 'coaches.coach_nomina', 'coaches.coach_correo');
    }
