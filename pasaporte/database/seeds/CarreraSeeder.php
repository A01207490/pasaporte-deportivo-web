...
class CarreraSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Carrera::create(['carrera_nombre' => 'Licenciado en Innovación Educativa', 'created_at' => NOW(), 'updated_at' => NOW()]);
        Carrera::create(['carrera_nombre' => 'Licenciado en Periodismo', 'created_at' => NOW(), 'updated_at' => NOW()]);
        ...
        Carrera::create(['carrera_nombre' => 'Licenciado en Letras Hispánicas', 'created_at' => NOW(), 'updated_at' => NOW()]);
        Carrera::create(['carrera_nombre' => 'Licenciado en Tecnología y Producción Musical', 'created_at' => NOW(), 'updated_at' => NOW()]);
        Carrera::create(['carrera_nombre' => 'Ingeniero Civil', 'created_at' => NOW(), 'updated_at' => NOW()]);
        ...
        Carrera::create(['carrera_nombre' => 'Ingeniero Biomédico', 'created_at' => NOW(), 'updated_at' => NOW()]);
        ...
        Carrera::create(['carrera_nombre' => 'Ingeniero en Tecnologías Computacionales', 'created_at' => NOW(), 'updated_at' => NOW()]);
        ...
        Carrera::create(['carrera_nombre' => 'Ingeniero en Ciencias de Datos y Matemáticas', 'created_at' => NOW(), 'updated_at' => NOW()]);
        Carrera::create(['carrera_nombre' => 'Ingeniero en Nanotecnología', 'created_at' => NOW(), 'updated_at' => NOW()]);
        Carrera::create(['carrera_nombre' => 'Ingeniero Físico Industrial', 'created_at' => NOW(), 'updated_at' => NOW()]);
        Carrera::create(['carrera_nombre' => 'Licenciado en Negocios Internacionales', 'created_at' => NOW(), 'updated_at' => NOW()]);
        ...
        Carrera::create(['carrera_nombre' => 'Licenciado en Inteligencia de Negocios', 'created_at' => NOW(), 'updated_at' => NOW()]);
        ...
        Carrera::create(['carrera_nombre' => 'Licenciado en Desarrollo de Talento y Cultura Organizacional', 'created_at' => NOW(), 'updated_at' => NOW()]);
        Carrera::create(['carrera_nombre' => 'Licenciado en Negocios Internacionales', 'created_at' => NOW(), 'updated_at' => NOW()]);
        Carrera::create(['carrera_nombre' => 'Licenciado en Biociencias', 'created_at' => NOW(), 'updated_at' => NOW()]);
        Carrera::create(['carrera_nombre' => 'Licenciado en Psicología Clínica y de la Salud', 'created_at' => NOW(), 'updated_at' => NOW()]);
